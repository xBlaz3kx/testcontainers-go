...
**YOU ARE IN: `tcgo/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/tcgo/` (rig root) or other directories
...
**Your mail address:** `tcgo/polecats/rust`
**Your rig:** tcgo
**Your Witness:** `tcgo/witness`
...
| Ask Witness for help | `gt mail send tcgo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`tcgo/witness`) when:
...
```bash
gt mail send tcgo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
